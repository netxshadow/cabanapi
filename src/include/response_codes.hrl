-define(CODES,[
  ...
  {<<"080">>,<<"Approved, ATC check in ContactLess Magstripe transaction">>},
  {<<"100">>,<<"Decline">>},
  ...
  {<<"199">>,<<"Decline, invalid Date of Births">>},
  {<<"200">>,<<"Pick-up">>},
  ...
  {<<"0Y1">>,<<"Approved in Offline. Used only in advices">>},
  {<<"0Y3">>,<<"Tried to go Online, not succeed, in Offline. Used only in advices">>}
]).
